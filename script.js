...
function renderStudentDataScreen() {
    return '<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">' +
        ...
        '<p class="text-gray-600">Parcial 2 07/10/2025</p></div>' +
        ...
        '<p class="text-xs text-blue-800">💾 <strong>Al finalizar:</strong> Se descargara un archivo cifrado. Envialo al docente al correo perez.rafael@eam.edu.co.</p>' +
        '</div>' +
        '</div>' +
...
function renderSingleQuestion() {
    ...
    /*} else if (q.type === 'open') {
        ...
        // Mostrar la pregunta formateada en un div separado
        html += '<div class="bg-gray-50 p-4 rounded-lg mb-4 text-sm leading-relaxed" style="white-space: pre-line;">' + formattedQuestion + '</div>';
